    ...
    <div id="container">
        ...
        <div id="main_content">
            ...
            <div id="form_login">
                ...
                <p>
                    Bạn đã đăng kí thành công !!!<br/>
                    Hãy quay về trang đăng nhập để đăng nhập bằng tài khoản vừa đăng kí<br/>
                    <a href="http://localhost:8080/Case_Study_Module_2_Project_war_exploded/login.jsp">Trang Đăng Nhập</a>
                </p>
            </div>
        </div>
